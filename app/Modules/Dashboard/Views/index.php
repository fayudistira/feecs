...
<div class="row mb-4">
    <div class="col">
        <h4 class="fw-bold">Ringkasan Dasbor</h4>
        <p class="text-muted mb-0">Selamat datang kembali, <?= esc($user->username) ?>. Berikut adalah ringkasan sistem Anda hari ini.</p>
    </div>
</div>
...
<div class="row g-3 mb-4">
        ...
        <div class="col-lg-6">
            <div class="dashboard-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span><i class="bi bi-file-earmark-text me-2"></i>Statistik Pendaftaran</span>
                    <a href="<?= base_url('admission') ?>" class="btn btn-outline-dark-red btn-sm">Lihat Semua</a>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-6">
    ...
    <?php if ($programStats && !empty($programStats)): ?>
        <div class="col-lg-6">
            <div class="dashboard-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span><i class="bi bi-mortarboard me-2"></i>Program berdasarkan Kategori</span>
                    <a href="<?= base_url('program') ?>" class="btn btn-outline-dark-red btn-sm">Lihat Semua</a>
                </div>
...
<?php if ($paymentStats): ?>
    <div class="row g-3 mb-4">
        <div class="col-12">
            <div class="dashboard-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span><i class="bi bi-cash-coin me-2"></i>Statistik Pembayaran (Tahun Berjalan)</span>
                    <a href="<?= base_url('payment/reports/revenue') ?>" class="btn btn-outline-dark-red btn-sm">Lihat Laporan</a>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="p-3 border rounded text-center">
                                ...
                                <div class="stat-label">Invoice Terlambat</div>
                                <div class="progress mt-2" style="height: 6px;">
                    ...
                    <?php if (!empty($paymentStats['revenue_by_method'])): ?>
                        <div class="row mt-4">
                            <div class="col-12">
                                <h6 class="mb-3">Pendapatan berdasarkan Metode Pembayaran</h6>
                                <div class="row g-3">
