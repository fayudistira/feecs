...
<div class="hero-section position-relative overflow-hidden py-5" style="min-height: 70vh;">
    <div class="position-absolute top-0 start-0 w-100 h-100" style="background: radial-gradient(circle at 10% 20%, rgba(230, 57, 70, 0.2) 0%, transparent 50%); pointer-events: none;"></div>
    <div class="position-absolute bottom-0 end-0 w-100 h-100" style="background: radial-gradient(circle at 90% 80%, rgba(230, 57, 70, 0.2) 0%, transparent 50%); pointer-events: none;"></div>

    <div class="container position-relative">
        <div class="row align-items-center">
            <div class="col-lg-7 mb-5 mb-lg-0">
                <div class="d-flex align-items-center gap-3 mb-4">
                    <img src="https://flagcdn.com/w80/jp.png" alt="Japan Flag" class="rounded shadow" width="60" height="40">
                    <div class="badge bg-white text-danger p-2 px-3 rounded-pill shadow-sm">
                        <span class="fw-bold">JLPT Ready</span>
                    </div>
                </div>
                <h1 class="display-3 fw-bold mb-4 text-white">
                    Kursus Bahasa Jepang
                </h1>
                <h2 class="h3 text-white-50 mb-4">日本語コース</h2>
                <!-- Meta Tags -->
                <div class="d-flex flex-wrap gap-2 mb-4">
                    ...
                    <span class="badge bg-white bg-opacity-30 text-white px-3 py-2 rounded-pill border border-white border-opacity-25">
                        <i class="bi bi-award me-1"></i> Sertifikat JLPT
                    </span>
                    <span class="badge bg-white bg-opacity-30 text-white px-3 py-2 rounded-pill border border-white border-opacity-25">
                ...
                <p class="lead mb-4 text-white-50" style="font-size: 1.2rem;">
                    Raih kesempatan bekerja atau kuliah di Jepang! Bergabunglah dengan SOS Course and Training dan persiapkan diri Anda untuk JLPT.
                </p>
                <div class="d-flex flex-wrap gap-3">
                    <a href="https://wa.me/6285810310950?text=Hai,%20saya%20tertarik%20dengan%20kursus%20Bahasa%20Jepang"
                        target="_blank"
            ...
            <div class="col-lg-5 text-center">
                <div class="bg-white bg-opacity-10 rounded-5 p-5 backdrop-blur">
                    ...
                    <h3 class="text-white fw-bold mb-3">日本語</h3>
                    <p class="text-white-50">Bahasa Jepang</p>
                    <div class="mt-4">
                        <div class="row g-3">
                            <div class="col-6">
                                <div class="bg-white bg-opacity-20 rounded-3 p-3">
                                    <div class="h4 fw-bold text-white mb-0">N5-N1</div>
                                    <small class="text-white-50">Level JLPT</small>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="bg-white bg-opacity-20 rounded-3 p-3">
...
<div class="container py-5">
    <div class="text-center mb-5">
        <h2 class="display-5 fw-bold mb-3" style="color: var(--dark-red);">Mengapa Belajar Bahasa Jepang?</h2>
        <p class="lead text-muted">Buka peluang karir dan studi di Jepang dengan kemampuan bahasa yang mumpuni</p>
    </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card border-0 shadow-sm h-100 hover-lift">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="fw-bold mb-3">Peluang Kerja</h5>
                    <p class="text-muted small mb-0">Banyak perusahaan Jepang membuka lowongan untuk pekerja asing yang fasih berbahasa Jepang.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card border-0 shadow-sm h-100 hover-lift">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="fw-bold mb-3">Studi di Jepang</h5>
                    <p class="text-muted small mb-0">Kuliah di universitas ternama Jepang dengan beasiswa MEXT dan program lainnya.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card border-0 shadow-sm h-100 hover-lift">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="fw-bold mb-3">Budaya Jepang</h5>
                    <p class="text-muted small mb-0">Nikmati anime, manga, dan budaya pop Jepang tanpa terjemahan.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card border-0 shadow-sm h-100 hover-lift">
                <div class="card-body text-center p-4">
                    ...
                    <h5 class="fw-bold mb-3">Sertifikasi JLPT</h5>
                    <p class="text-muted small mb-0">Dapatkan sertifikasi JLPT yang diakui internasional untuk keperluan karir dan akademik.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="py-5 bg-light">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="display-5 fw-bold mb-3" style="color: var(--dark-red);">Program Jepang Tersedia</h2>
        ...
        <?php else: ?>
            <div class="text-center py-5">
                ...
                <p class="text-muted">Belum ada program Jepang yang tersedia saat ini. Silakan hubungi kami untuk informasi lebih lanjut.</p>
                <a href="https://wa.me/6285810310950?text=Hai,%20saya%20mau%20tanya%20tentang%20program%20Jepang"
                    target="_blank"
    ...
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-lg h-100">
                    <div class="card-header bg-danger text-white py-3">
                        <h5 class="fw-bold mb-0">N5-N4 (Beginner)</h5>
                    </div>
                    <div class="card-body">
                        <ul class="list-unstyled mb-4">
                            <li class="mb-2"><i class="bi bi-check-circle-fill text-success me-2"></i>Hiragana & Katakana dasar</li>
                            <li class="mb-2"><i class="bi bi-check-circle-fill text-success me-2"></i>Kanji dasar (100-300 karakter)</li>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-lg h-100">
                    <div class="card-header bg-danger text-white py-3">
                        <h5 class="fw-bold mb-0">N3 (Intermediate)</h5>
                    </div>
                    <div class="card-body">
                        <ul class="list-unstyled mb-4">
                            <li class="mb-2"><i class="bi bi-check-circle-fill text-success me-2"></i>Percakapan bisnis dasar</li>
                            <li class="mb-2"><i class="bi bi-check-circle-fill text-success me-2"></i>Kanji lanjutan (600 karakter)</li>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card border-0 shadow-lg h-100">
                    <div class="card-header bg-danger text-white py-3">
                        <h5 class="fw-bold mb-0">N2-N1 (Advanced)</h5>
                    </div>
                    <div class="card-body">
                        <ul class="list-unstyled mb-4">
                            <li class="mb-2"><i class="bi bi-check-circle-fill text-success me-2"></i>Fluensi tingkat tinggi</li>
                            <li class="mb-2"><i class="bi bi-check-circle-fill text-success me-2"></i>Kanji mahir (1000-2000 karakter)</li>
                            <li class="mb-2"><i class="bi bi-check-circle-fill text-success me-2"></i>Bisnis Jepang profesional</li>
                            <li class="mb-2"><i class="bi bi-check-circle-fill text-success me-2"></i>Preparasi kerja/kuliah di Jepang</li>
                        </ul>
                        <a href="<?= base_url('apply') ?>" class="btn btn-dark-red w-100">Daftar Level Ini</a>
                    </div>
                </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="d-flex gap-4 mb-4">
                ...
                <div>
                    ...
                    <p class="text-muted small mb-0">Belajar langsung dari pengajar asli Jepang dengan pengalaman mengajar profesional.</p>
                </div>
            </div>
            ...
            <div class="d-flex gap-4 mb-4">
                ...
                <div>
                    <h5 class="fw-bold">Kurikulum Standar JLPT</h5>
                    <p class="text-muted small mb-0">Mengikuti standar internasional JLPT untuk memastikan kualitas pembelajaran.</p>
                </div>
            </div>
            ...
            <div class="d-flex gap-4 mb-4">
                ...
                <div>
                    ...
                    <p class="text-muted small mb-0">Kami menjamin kemampuan Jepang Anda meningkat dengan metode yang terbukti efektif.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="bg-gradient-danger rounded-5 p-5 text-white shadow-lg">
                ...
                <div class="bg-white bg-opacity-20 rounded-4 p-4 mb-4">
                    <h5 class="fw-bold mb-2">Tamashii Japanese Center</h5>
                    <p class="small mb-0 opacity-75">Partner resmi untuk program Bahasa Jepang. Menyediakan kurikulum standar Jepang dengan instruktur native speaker.</p>
                </div>
                <div class="row g-3">
                    <div class="col-6">
                        <div class="bg-white bg-opacity-20 rounded-3 p-3 text-center">
                            <div class="h4 fw-bold mb-0">N5-N1</div>
                            <small class="opacity-75">Level JLPT</small>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="bg-white bg-opacity-20 rounded-3 p-3 text-center">
...
<div class="py-5 bg-gradient-danger text-white">
    <div class="container text-center py-5">
        <h2 class="display-5 fw-bold mb-3">Siap Menguasai Bahasa Jepang?</h2>
        <p class="lead mb-4 opacity-75">Daftar sekarang dan dapatkan konsultasi gratis dengan pengajar kami.<br>Mulai perjalanan bahasa Jepang Anda bersama SOS Course and Training!</p>
